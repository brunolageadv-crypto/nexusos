  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        padding: '48px 40px',
        textAlign: 'center',
        boxShadow: '0 0 0 1px rgba(0,229,255,0.05), 0 32px 80px rgba(0,0,0,0.6)',
      }}>
        ...
        <button
          ...
          style={{
            ...
            width: '100%',
            padding: '14px 20px',
            background: loading ? 'rgba(0,229,255,0.05)' : 'rgba(0,229,255,0.08)',
          ...
          onMouseEnter={e => {
            if (!loading) {
              ...
              ;(e.currentTarget as HTMLElement).style.borderColor = 'rgba(0,229,255,0.6)'
              ;(e.currentTarget as HTMLElement).style.boxShadow = '0 0 24px rgba(0,229,255,0.2)'
            }
          }}
          onMouseLeave={e => {
        ...
        {error && (
          <p style={{ color: '#f87171', fontSize: '0.8rem', marginTop: 16 }}>{error}</p>
        )}
        ...
        <p style={{
          ...
          ACESSO AUTORIZADO APENAS PARA BRUNOLAGEADV
        </p>
      </div>
    </div>
  )
